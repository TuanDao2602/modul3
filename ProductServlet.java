        ...
        if (action.equals("Create")) {
            ...
            for (Part part : request.getParts()) {
                if (part.getName().equals("proImage")) {
                    ...
                    part.write(pathFolderImage + File.separator + product.getProductImages());
                } else if (part.getName().equals("subImages")) {
                    product.getListImage().add(part.getSubmittedFileName());
                    InputStream fileContent = part.getInputStream();
                    part.write(pathFolderImage + File.separator + product.getListImage() );
                }
            }
            ...
            if (result) {
                ...
                for (Part part : request.getParts()) {
                    if (part.getName().equals("proImage")) {
                        ...
                        part.write(pathFolderImage + File.separator + proNew.getListImage() );
                    }
                }
                boolean result = productService.save(product);
                if (result){
